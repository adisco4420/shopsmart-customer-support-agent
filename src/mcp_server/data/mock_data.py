...
PRODUCTS: list[dict] = [
    {
        ...
        "description": (
            ...
            "active noise cancellation, and multi-device Bluetooth pairing."
        ),
        "rating": 4.7,
    },
    {
        ...
        "sku": "CH-ERG-002",
        "description": (
            "Fully adjustable lumbar support, breathable mesh back, "
            "4D armrests. Supports up to 300 lbs."
        ),
        "rating": 4.5,
    },
    {
        ...
        "sku": "TV-4K-55-003",
        "description": (
            "55-inch 4K OLED display, built-in streaming apps, "
            "voice control, and HDR10+ support."
        ),
        "rating": 4.6,
    },
    {
        ...
        "sku": "WB-SS-004",
        "description": (
            "32oz double-wall vacuum insulated bottle. "
            "Keeps drinks cold 24hrs, hot 12hrs. BPA-free."
        ),
        "rating": 4.8,
    },
    {
    ...
    },
    {
        ...
        "sku": "KB-MECH-006",
        "description": (
            "Tenkeyless layout, Cherry MX Red switches, RGB per-key backlighting, "
    ...
    },
    {
        ...
        "sku": "YM-NS-007",
        "description": (
            "6mm thick premium TPE mat with alignment lines. "
            "72 x 24 inches. Includes carry strap."
        ),
        "rating": 4.6,
    },
    {
        ...
        "sku": "CM-12C-008",
        "description": (
            "Programmable 12-cup drip coffee maker with built-in grinder, "
            "thermal carafe, and brew-strength selector."
        ),
        "rating": 4.3,
    },
]
...
ORDERS: dict[str, dict] = {
    "ORD-12345": {
        ...
        "status": "shipped",
        "items": [
            {"product_id": "PRD-001", "name": "Wireless Noise-Cancelling Headphones",
             "qty": 1, "price": 299.99},
            {"product_id": "PRD-004", "name": "Stainless Steel Water Bottle",
             "qty": 1, "price": 34.99},
        ],
        "subtotal": 334.98,
        "shipping": 0.00,
    ...
    "ORD-99871": {
        ...
        "status": "processing",
        "items": [
            {"product_id": "PRD-003", "name": "4K Ultra HD Smart TV - 55 inch",
             "qty": 1, "price": 699.99},
        ],
        "subtotal": 699.99,
        "shipping": 0.00,
...
KB_ARTICLES: list[dict] = [
    {
        ...
        "content": (
            ...
            "1) Log into your ShopSmart account and go to 'My Orders' — "
            "click any order to see real-time tracking. "
            "2) Use the tracking number from your shipping confirmation email "
            "on the carrier's website (UPS, FedEx, or USPS). "
    ...
    },
    {
        ...
        "content": (
            "ShopSmart accepts returns within 30 days of delivery. "
            "Items must be unused and in original packaging. "
            "To start a return: contact support or use our Returns Portal. "
            "Once approved, ship the item back using the prepaid label we email you. "
    ...
    },
    {
        ...
        "content": (
            ...
            "Gold members get free standard shipping on all orders. "
            "Platinum members get free expedited shipping. "
    ...
    },
    {
        ...
        "content": (
            ...
            "Platinum ($99/year) — 5% cashback, free expedited shipping, "
    ...
    },
    {
        ...
        "content": (
            "You can cancel an order within 1 hour of placing it, "
            "as long as it has not entered 'processing' status. "
            "To cancel: go to My Orders > select the order > click 'Cancel Order'. "
            "If the order is already processing or shipped, you cannot cancel it "
    ...
    },
    {
        ...
        "content": (
            ...
            "then submit a support ticket with the photos attached. "
    ...
    },
    {
        ...
        "content": (
            "ShopSmart accepts: Visa, Mastercard, American Express, Discover, "
            "PayPal, Apple Pay, Google Pay, and ShopSmart Gift Cards. "
